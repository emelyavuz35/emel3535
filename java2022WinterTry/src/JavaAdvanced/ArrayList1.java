...
public class ArrayList1 {
    ...
    Array'ler Array.toString(arrayAdi); ile yazdirilabilir.
 ...
 */
         ...
         */
                ...
                //list teki istenen herhangi bir  elemanı update (set) etme: name.set(index,eleman);--> şu index deki elemanı şu eleman ile değiştir.
