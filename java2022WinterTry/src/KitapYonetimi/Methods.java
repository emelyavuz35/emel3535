...
public class Methods {
    ...
    public class Method {
        ...
        static List<Book> kitaplarList = new ArrayList<>();
        ...
        public static void islemSecim() throws InterruptedException {
            ...
            int secim = 0;
            try {
                secim = scan.nextInt();//int deger yerine string girerse exception yakala ve giris methoduna gonder
            } catch (Exception e) {
        ...
        public static void kitapBilgiileGoruntule() throws InterruptedException {
        ...
        public static void kitapnoileSil() throws InterruptedException {
            for (int i = 0; i < kitaplarList.size(); i++) {
                System.out.println(kitaplarList.get(i).getKitapNo());
            }
            ...
            if (!bulunduMu) System.out.println("Aradiginiz kriterler uygun sonuc bulunamadi. ");
            System.out.println("Lutfen bekleyiniz.");//console'da bir bekleme süresi bıtakıyor
            Thread.sleep(3000); //
            while (true) {
        ...
        public static void tumkitaplariListele() throws InterruptedException {
            for (int i = 0; i < kitaplarList.size(); i++) {
                System.out.print("Kitap no  : " + kitaplarList.get(i).getKitapNo() + " ");
                System.out.print("Kitap adi : " + kitaplarList.get(i).getKitapAdi() + " ");
                System.out.print("Yazar adi : " + kitaplarList.get(i).getYazarAdi() + " ");
